...
export const cropData = [
  ...
  },
  {
    id: "potato",
    name: "Potato",
    image: "/src/assets/crops/potato.jpg",
    description: "Root crop; monitor for blight carefully",
    commonPests: ["Colorado beetle", "aphids", "late blight"],
    inspectionAngle: "Upper and lower leaf surfaces",
  },
  {
    id: "apple",
    name: "Apple",
    image: "/src/assets/crops/apple.jpg",
    description: "Tree fruit; watch for scab and pests",
    commonPests: ["aphids", "codling moth", "apple scab"],
    inspectionAngle: "Leaf clusters and fruit surface",
  },
  {
    id: "corn",
    name: "Corn (Maize)",
  ...
  },
  {
    id: "peach",
    name: "Peach",
    image: "/src/assets/crops/peach.jpg",
    description: "Stone fruit; susceptible to leaf curl",
    commonPests: ["aphids", "peach leaf curl", "borers"],
    inspectionAngle: "Leaf surfaces and fruit",
  },
  {
    id: "grape",
    name: "Grape",
    image: "/src/assets/crops/grape.jpg",
    description: "Vine crop; prone to powdery mildew",
    commonPests: ["powdery mildew", "grape phylloxera", "leafhoppers"],
    inspectionAngle: "Leaf underside and grape clusters",
  },
  {
    id: "cherry",
    name: "Cherry",
    image: "/src/assets/crops/cherry.jpg",
    description: "Tree fruit; watch for fruit flies",
    commonPests: ["cherry fruit fly", "aphids", "brown rot"],
    inspectionAngle: "Fruit and leaf surfaces",
  },
];
